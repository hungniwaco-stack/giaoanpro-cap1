...
function buildPrompt(monHoc: string, khoiLop: string, tenBai: string, soBai: number) {
  return `Bạn là giáo viên Tiểu học Việt Nam giàu kinh nghiệm ra bài tập luyện tập, bám sát chương trình GDPT 2018. Ngôn ngữ đơn giản, phù hợp lứa tuổi học sinh lớp ${khoiLop}.
