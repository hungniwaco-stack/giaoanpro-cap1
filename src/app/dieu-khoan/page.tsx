...
export const metadata: Metadata = { title: "Điều khoản sử dụng — AI Giáo Án Pro" };

export default function TermsPage() {
  return (
    <LegalPage title="Điều khoản sử dụng" updatedAt="31/08/2026">
      <h2>1. Dịch vụ cung cấp</h2>
      <p>
        AI Giáo Án Pro là công cụ hỗ trợ giáo viên Tiểu học soạn thảo kế hoạch bài dạy tham khảo dựa
        trên Công văn 2345/BGDĐT-GDTH, sử dụng mô hình trí tuệ nhân tạo (Google Gemini) để tạo nội dung.
      </p>
