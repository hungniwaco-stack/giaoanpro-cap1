...
export const metadata: Metadata = { title: "Điều khoản sử dụng — Giáo Án Pro Cấp 1" };
...
export default function TermsPage() {
  return (
    <LegalPage title="Điều khoản sử dụng" updatedAt="07/09/2026">
      ...
      <p>
        Giáo Án Pro Cấp 1 là công cụ hỗ trợ giáo viên Tiểu học soạn giáo án, ra đề, tạo bài tập dựa
        trên Công văn 2345/BGDĐT-GDTH, dùng AI (Google Gemini) để tạo nội dung.
      </p>
